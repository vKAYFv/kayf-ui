    ...
    <div style="display:flex; align-items:center; justify-content:center; padding:60px;">
      ...
      >
        <div style="font-family:Inter,system-ui,sans-serif;">
          <h3 style="margin:0 0 8px; font-size:18px; font-weight:600; color:#f4f4f7; letter-spacing:-0.02em;">Card Title</h3>
          <p style="margin:0; font-size:13px; color:rgba(228,228,231,0.45); line-height:1.6;">
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:20px; padding:40px; max-width:680px; margin:0 auto;">
      <kayf-noise-card variant="default"  glow="cyan"   padding="20px">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:14px; color:rgba(228,228,231,0.6);">Standard dark surface</div>
        </div>
      </kayf-noise-card>
      <kayf-noise-card variant="elevated" glow="purple" padding="20px">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:14px; color:rgba(228,228,231,0.6);">Deeper shadow & border</div>
        </div>
      </kayf-noise-card>
      <kayf-noise-card variant="flat"     glow="green"  padding="20px">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:14px; color:rgba(228,228,231,0.6);">Minimal subtle border</div>
        </div>
      </kayf-noise-card>
      <kayf-noise-card variant="glass"    glow="gold"   padding="20px">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:14px; color:rgba(228,228,231,0.6);">Frosted backdrop blur</div>
        </div>
      </kayf-noise-card>
    </div>
  `,
      ...
      ${(['blue','cyan','purple','green','red','orange','gold'] as const).map(g => html`
        <kayf-noise-card glow=${g} variant="elevated" padding="16px 20px" style="flex:1; min-width:110px; max-width:140px;">
          <div style="font-family:Inter,system-ui,sans-serif; text-align:center;">
            <div style="font-size:13px; color:rgba(228,228,231,0.7); font-weight:500;">${g}</div>
          </div>
        </kayf-noise-card>
      `)}
    </div>
      ...
      <kayf-noise-card variant="elevated" glow="gold" padding="24px" style="width:300px;">
        <div style="font-family:Inter,system-ui,sans-serif;">
          <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px;">
            ...
            <span style="font-size:11px; color:rgba(228,228,231,0.25);">2024</span>
          </div>
          <div style="display:grid; grid-template-columns:1fr 1fr 1fr; gap:16px; text-align:center;">
            <div>
              <div style="font-size:26px; font-weight:800; color:#f8c868; letter-spacing:-0.03em;">47</div>
              <div style="font-size:10px; color:rgba(228,228,231,0.35); text-transform:uppercase; letter-spacing:0.08em; margin-top:3px;">Wins</div>
            </div>
            <div>
              <div style="font-size:26px; font-weight:800; color:#f4f4f7; letter-spacing:-0.03em;">12</div>
              <div style="font-size:10px; color:rgba(228,228,231,0.35); text-transform:uppercase; letter-spacing:0.08em; margin-top:3px;">Losses</div>
            </div>
            <div>
              <div style="font-size:26px; font-weight:800; color:#51dfa4; letter-spacing:-0.03em;">79%</div>
              <div style="font-size:10px; color:rgba(228,228,231,0.35); text-transform:uppercase; letter-spacing:0.08em; margin-top:3px;">Win Rate</div>
            </div>
          </div>
          <div style="margin-top:20px; height:3px; background:rgba(255,255,255,0.06); border-radius:2px; overflow:hidden;">
            <div style="width:79%; height:100%; background:linear-gradient(90deg, #f8c868, #51dfa4); border-radius:2px;"></div>
          </div>
        </div>
      </kayf-noise-card>
    </div>
    ...
    <div style="display:flex; gap:16px; padding:40px; flex-wrap:wrap; justify-content:center;">
      <kayf-noise-card variant="elevated" glow="cyan" padding="20px" style="width:200px;">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:28px; font-weight:800; color:#f4f4f7;">34%</div>
          <div style="margin-top:10px; height:2px; background:rgba(255,255,255,0.06); border-radius:1px;">
            <div style="width:34%; height:100%; background:#62daf7; border-radius:1px;"></div>
          </div>
        </div>
      </kayf-noise-card>
      <kayf-noise-card variant="elevated" glow="purple" padding="20px" style="width:200px;">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:28px; font-weight:800; color:#f4f4f7;">68%</div>
          <div style="margin-top:10px; height:2px; background:rgba(255,255,255,0.06); border-radius:1px;">
            <div style="width:68%; height:100%; background:#8b7cff; border-radius:1px;"></div>
          </div>
        </div>
      </kayf-noise-card>
      <kayf-noise-card variant="elevated" glow="green" padding="20px" style="width:200px;">
        <div style="font-family:Inter,system-ui,sans-serif;">
          ...
          <div style="font-size:28px; font-weight:800; color:#f4f4f7;">12ms</div>
          <div style="margin-top:10px; height:2px; background:rgba(255,255,255,0.06); border-radius:1px;">
            <div style="width:12%; height:100%; background:#51dfa4; border-radius:1px;"></div>
          </div>
        </div>
      </kayf-noise-card>
    </div>
